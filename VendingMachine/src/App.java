...
import Services.VendingMachineGUI;
...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4=new HotDrink(120, 4, "Coffe", 65);//создали напиток
        Product item5=new HotDrink(90, 5, "Tea", 202, 80);
        assort.add(item1);
        assort.add(item2);
        assort.add(item3);
        assort.add(item4);//добавили в ассортимент
        assort.add(item5);
